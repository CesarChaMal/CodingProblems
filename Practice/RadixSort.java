...
public class RadixSort {
	...
	public static void main(String args[]){
		...
		QueueNode n3 = new QueueNode(6, null);
		QueueNode n4 = new QueueNode(2, null);
		QueueNode n5 = new QueueNode(1, null);
		QueueNode n6 = new QueueNode(4, null);
		QueueNode n7 = new QueueNode(2, null);
		QueueNode n8 = new QueueNode(8, null);
		QueueNode n9 = new QueueNode(5, null);
		QueueNode n10 = new QueueNode(3, null);
